...
from workspace_governance_facades import (
    _has_star_import,
    _is_concrete_facade_path,
    _tracked_compatibility_facade_paths,
)
from workspace_governance_facades import (
    check_compatibility_facades as _check_compatibility_facades,
)
...
SCRIPT_LIFECYCLE_EXTRA_PATHS = {
    ...
    "strategy-research/src/style_factors/style_factor_attribution.py",
}
