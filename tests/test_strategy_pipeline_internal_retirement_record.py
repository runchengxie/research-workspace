...
def test_final_retirement_evidence_records_private_archive_and_recovery() -> None:
    ...
    assert evidence["production_workspace_release"] == (
        "d31f007223d009a16f76368161536e4be5a51d89"
    )
    assert evidence["observed_local_production_workspace_release"] == evidence[
        "production_workspace_release"
    ]
