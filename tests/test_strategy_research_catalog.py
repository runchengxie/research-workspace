...
def test_strategy_catalog_is_complete_and_human_navigable() -> None:
    ...
    assert _is_empty_or_absent(ROOT / "strategy-research/research/strategies/niu_men_line")
    assert _is_empty_or_absent(ROOT / "strategy-research/research/experiments/niu_men_line")
