...
| 宏观情境 Contextual Alpha Shadow | exploration | 否 | [experiments/macro_context_shadow/README.md](experiments/macro_context_shadow/README.md) | `market-data-platform`、`alpha-research`、`portfolio-backtester` |
