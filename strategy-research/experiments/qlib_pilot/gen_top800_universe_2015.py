...
OUT = '/home/richard/code/research-workspace-perf/strategy-research/experiments/qlib_pilot/universe_top800_2015.csv'
TOP_N = 800
...
def read_date(f):
    ...
    return d[d['trade_date']>='20150101'][d['trade_date']<='20260807']
