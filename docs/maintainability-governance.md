...
| 生成的维护债基线 | [evidence/maintainability/baseline-20260719-ty.json](evidence/maintainability/baseline-20260719-ty.json) |
...
```bash
python scripts/maintainability_baseline.py --out docs/evidence/maintainability/baseline-20260719-ty.json
```
