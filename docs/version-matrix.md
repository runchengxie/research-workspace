...
| component | commit |
| --- | --- |
| workspace | `8d2f5fd` + local changes |
| market-data-platform | `e802f12` |
| cross-sectional-trees | `b6e4cad` |
| quant-execution-engine | `dc520cf` |
