...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-08-17 | 本次提交 | `e9c4994` | `82677ef` | `45b7c0b` | `87064c2` | `f2b35e7` | `f0b9086` | DailyWatch20 生产候选池升级为 `ths_hot_strict_v3`。rank 1 必须存在，其余名次允许至多两个经审计的源端缺口。原始 rank 保持不变，不补位、不重排，有限缺口交付显式标记为 degraded。strict-v2 历史语义保持不变 | market-data-platform PR #42/#43 在 Python 3.12 下 `708 passed, 1 skipped`。alpha-research PR #24 为 `277 passed, 3 skipped`。strategy-app PR #29 完整门禁通过，pytest `188 passed`。strategy-pipeline PR #68 完整门禁为 `1137 passed, 1 skipped`，隔离 wheel smoke 通过。market-intel PR #102 的全量测试、类型和维护性门禁通过，`daily_messenger` 覆盖率为 71.35%。顶层 full 门禁、六个子模块 smoke、doctor 和契约检查通过，顶层 pytest 为 `298 passed`。 |
