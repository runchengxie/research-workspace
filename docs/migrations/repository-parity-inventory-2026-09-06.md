...
| `strategy-research` | `quant-research/registry` and `research` | partial | private staging green (`26 passed`) | DailyWatch20 slice documented | DailyWatch20 slice migrated | transfer all strategy identities, evidence, experiments, and lifecycle records |
| `strategy-app` | `quant-research/strategies` | partial | adapter tests green (`3 passed`) | DailyWatch20 slice documented | DailyWatch20 slice migrated | transfer remaining strategy logic, specs, tests, and runtime dependencies |
