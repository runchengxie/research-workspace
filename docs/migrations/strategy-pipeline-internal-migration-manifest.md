  ...
  "partial_code_migrations": [
    {
      ...
      "test_evidence": "strategy-pipeline clean-room control-plane tests: 21 passed; strategy-research tests/test_run_metadata.py: 2 passed; market-data-platform contract matching and loader tests: 4 passed, path-kind tests: 2 passed, configured-root tests: 2 passed; internal output metadata, provenance, contract matching, input path, manifest, loader, migrated path-kind, and configured-root regression tests: 21 passed",
