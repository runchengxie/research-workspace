...
| `research-run.manifest.json` | `research.backtest-run.v1` | `strategy-pipeline` 生成 | `strategy_pipeline.research_evidence`、`research_contracts.research_run_manifest` | 根运行 lineage、证据等级、研究时钟和 artifact hash |
