...
| `signals.meta.json` | `alpha_research.signals metadata` | `alpha-research` | `signal_artifact_summary` | contract name、schema version、文件路径、行数、required columns |
...
| `signals_style_replica.meta.json` | `alpha_research.signals metadata` | `alpha-research` | `StyleReplicaSignalGenerator.write` | contract name、schema version、model_version、config (a/b slots、theme quotas) |
